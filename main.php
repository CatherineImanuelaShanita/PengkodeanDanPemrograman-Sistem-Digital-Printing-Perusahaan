...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light px-6 font-regular" id="navbar">
        <div class="container-fluid">
            ...
            <div class="blue-theme font-bold fs-1">Digitalistic</div>
            </a>
                ...
                <div class="col">
                    <div class="welcoming mt-6">
                        <h3 class="font-semibold">
                            Find all your needs in <span class="blue-theme">digital printing</span>
                            at our place,<br>
                            <span class="blue-theme">Digitalistic</span>.
                        </h3>
            ...
            <div class="container my-5 py-5">
                <div class="row text-center text-center">
                    <div class="col rounded w-100">
                        ...
                        <p class="mb-5 font-regular mt-4">In <span class="blue-theme">Digitalistic</span>, we really maintain our quality in serving our customers, <br>
    ...
    <section id="jump-ourproduct">
                            ...
                            <div class="col">
                                <div class="card" style="width: 80%">
                                    <a href="products.php" class="text-decoration-none ">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title font-semibold blue-theme blue-hover" >Products</h5>
                                ...
                                <div class="card" style="width: 80%">
                                    <a href="materials.php" class="text-decoration-none">
                                        ...
                                        <div class="card-body" href="#">
                                            <h5 class="card-title blue-theme font-semibold blue-hover" >Materials</h5>
            ...
            <div class="container my-5 py-5 px-5 d-flex justify-content-around">
                <div class="row">
                    <div class="col-6 py-5">
                        <h2 class="font-bold blue-theme">Digitalistic</h2>
                    ...
                    <div class="col-6" data-aos="fade-left">
                        ...
                        <a class="nav-link text-start text-black font-semibold" href="#"><img src="assets/whatsapp.svg">
                            +62 812 345 6789</a>
                        <a class="nav-link font-semibold text-black text-start" href="#"><img src="assets/instagram.svg"> @Digitalisticprint
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container my-5 py-5 mt-6" data-aos="fade-up">
                <div class="row text-center">
                    <div class="col">
                        ...
                        <h3 class="font-bold blue-theme">Digitalistic</h3>
                    </div>
                </div>
        ...
        <nav class="navbar bottom navbar-expand-sm navbar-dark blue-background px-6 pb-3">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><div class="black font-bold fs-1">Digitalistic</div></a>
                <!-- <div class="blue-theme font-bold fs-1">Digitalistic</div> -->
                <div class="text-light font-regular">© Copyright 2024. Design of digitalistic</div>
